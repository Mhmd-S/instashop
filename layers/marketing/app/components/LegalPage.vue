  ...
  <MarketingShell>
    <UContainer class="py-12 sm:py-16">
      <div class="mx-auto max-w-3xl">
        ...
        <div class="legal-prose mt-8 text-muted">
          <slot />
        </div>
      </div>
    </UContainer>
...
.legal-prose h2 { color: var(--ui-text-highlighted, currentColor); font-size: 1.2rem; font-weight: 600; margin: 2.25rem 0 .6rem; }
.legal-prose h3 { color: var(--ui-text-highlighted, currentColor); font-size: 1rem; font-weight: 600; margin: 1.4rem 0 .4rem; }
...
.legal-prose strong { color: var(--ui-text-highlighted, currentColor); font-weight: 600; }
